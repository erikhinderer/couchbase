 ...
 * brand's signature red for consistent in-app branding.
 */
...
export function CouchbaseWordmark() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
      ...
      <span style={{ fontWeight: 700, fontSize: 16, letterSpacing: "-0.01em", color: "#E8EAED" }}>
        Couchbase <span style={{ color: "#EA2328" }}>Migration Agent</span>
      </span>
    </div>
  );
}
